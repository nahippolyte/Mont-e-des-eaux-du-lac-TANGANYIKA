...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 12, minZoom: 6, projection: new ol.proj.Projection({
            code: 'EPSG:32735',
            //extent: [745689.027675, 9507782.068476, 887685.482421, 9744268.703880],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([715990.381938, 9615562.007336, 785171.173256, 9643290.340699], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Zone affectée par la montée des eaux du Lac TANGANYIKA</h2>';
        return titleElement;
    })(),
